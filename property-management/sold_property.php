...
<section id="add-property" class="my-properties properties-list" style="padding-top: 1px;padding-bottom: 10px;">
                        ...
                        <div class="property-item">
                            <div class="property--img">
                                <a href="property-single-gallery.php?id=<?php echo $result['property_id'];?>">
                                    ...
                                    ?>
                                    <img src="uploads/<?php echo $temp[0]; ?>" alt="property image" class="img-responsive">

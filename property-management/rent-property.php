<?php
  ...
  session_start();
    ...
    $qry = "SELECT * FROM tbl_property Where property_id='$property_id'";
      ...
      $rent = $interval * $result1['property_price'];
  ...
  if (isset($_SESSION['email'])) {
    ...
    { 
      ...
      if($result_cnt>0){
        ...
        $sql1 = "INSERT INTO tbl_rent(starting_date,ending_date,property_id,user_name,user_id) VALUES ('$starting_date','$ending_date','$property_id','$first_name','$u_id')";
        $res1=mysqli_query($con,$sql1);
